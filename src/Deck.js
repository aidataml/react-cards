...
function Deck() {
    ...
    function renderDrawBtnIfOk() {
        ...
        return (
        <button
            className="Deck-draw" onClick={draw} disabled={isShuffling}>Draw Card</button>
        );
    }
    ...
    function renderShuffleBtnIfOk() {
        if (!deck) return null;
        return (
        <button className="Deck-draw" onClick={startShuffling} disabled={isShuffling}>Shuffle Cards</button>
        );
    }
